...
return function (array $context) {
    ...
    $heycartHttpKernel = new HttpKernel($appEnv, $debug, $classLoader);

    if (EnvironmentHelper::getVariable('COMPOSER_PLUGIN_LOADER', false)) {
        $heycartHttpKernel->setPluginLoader(
            new ComposerPluginLoader($classLoader, null)
        );
    }

    return new class($heycartHttpKernel) implements HttpKernelInterface, TerminableInterface {
